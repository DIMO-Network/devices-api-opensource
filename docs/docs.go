...
// 2023-01-24 08:48:36.713424 -0700 MST m=+103.647468251
package docs
...
const docTemplate = `{
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/internal_controllers.PrivilegedDevices"
                        }
                    }
                }
            }
    ...
    "definitions": {
        ...
        "github.com_DIMO-Network_devices-api_internal_controllers.Device": {
            "type": "object",
            "properties": {
                "make": {
                    "type": "string"
        ...
        "github.com_DIMO-Network_devices-api_internal_controllers.PrivilegedAccessDevice": {
            "type": "object",
            "properties": {
                "ownerAddress": {
                    "type": "array",
                ...
                "type": {
                    "$ref": "#/definitions/github.com_DIMO-Network_devices-api_internal_controllers.Device"
                }
            }
        },
        "github.com_DIMO-Network_devices-api_internal_controllers.PrivilegedDevices": {
            "type": "object",
            "properties": {
                "devices": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/github.com_DIMO-Network_devices-api_internal_controllers.PrivilegedAccessDevice"
                    }
                }
            }
        },
