...
// 2022-06-14 17:28:37.793376 -0400 EDT m=+91.353718126
package docs
...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/documents": {
            ...
            "post": {
                ...
                "parameters": [
                    {
                        "description": "add document to user. either name and type are required",
                        "name": "user_device",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_controllers.DocumentRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/internal_controllers.MintSignatureData"
                        }
                    }
                }
            },
    ...
    "definitions": {
        ...
        "github.com_DIMO-Network_devices-api_internal_controllers.DocumentRequest": {
            "type": "object",
            "properties": {
                "name": {
                    "type": "string"
        ...
        "github.com_DIMO-Network_devices-api_internal_controllers.EIP712FieldType": {
            "type": "object",
            "properties": {
                "name": {
                    "type": "string"
        ...
        "github.com_DIMO-Network_devices-api_internal_controllers.MintSignatureData": {
            "type": "object",
            "properties": {
                "domain": {
                    "type": "any"
                ...
                "types": {
                    ...
                    "additionalProperties": {
                        "type": "array",
                        "items": {
                            "$ref": "#/definitions/github.com_DIMO-Network_devices-api_internal_controllers.EIP712FieldType"
                        }
                    }
                }
            }
        ...
        "internal_controllers.DocumentRequest": {
            "type": "object",
            "properties": {
                "name": {
                    "type": "string"
        ...
        "internal_controllers.EIP712FieldType": {
            "type": "object",
            "properties": {
                "name": {
                    "type": "string"
        ...
        "internal_controllers.MintSignatureData": {
            "type": "object",
            "properties": {
                "domain": {
                    "type": "any"
                ...
                "types": {
                    ...
                    "additionalProperties": {
                        "type": "array",
                        "items": {
                            "$ref": "#/definitions/internal_controllers.EIP712FieldType"
                        }
                    }
                }
            }
