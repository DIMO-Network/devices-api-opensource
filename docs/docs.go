...
// 2022-06-07 12:15:11.966992 -0500 -05 m=+337.547409345
package docs
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/github.com_DIMO-Network_devices-api_internal_controllers.DocumentRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/user/device-data/{userDeviceID}/historical": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "odometer. if empty all",
                        "name": "signal",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "description": "intervals for bucketing, 30m, 60m. if empty 30m",
                        "name": "interval",
                        "in": "query"
                    }
                ],
