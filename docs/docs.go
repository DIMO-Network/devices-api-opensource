...
// 2022-11-23 17:43:27.269719 -0500 EST m=+1.637980126
package docs
...
const docTemplate = `{
    ...
    "definitions": {
        ...
        "github.com_DIMO-Network_devices-api_internal_controllers.UpdateVINReq": {
            ...
            "properties": {
                "externalId": {
                    "description": "ExternalID is the unit ID of the AutoPi that signed the VIN.",
                    "type": "string",
                    "example": "febaf3bf-9a59-4fac-9df6-55228e904c28"
                },
                "signature": {
                    "description": "Signature is the hex-encoded result of the AutoPi signing the VIN.",
                    "type": "string",
