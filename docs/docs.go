...
// 2022-07-25 11:25:47.015065 -0400 EDT m=+1.505646251
package docs
...
const docTemplate = `{
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/github.com_DIMO-Network_devices-api_internal_controllers.ChargeLimitBody"
                        }
                    }
                ],
                "responses": {}
    ...
    "definitions": {
        ...
        "github.com_DIMO-Network_devices-api_internal_controllers.ChargeLimitBody": {
            ...
            "properties": {
                "chargeLimit": {
                    "description": "ChargeLimit is the charge limit, a value from 0.0 to 1.0, inclusive.\nNote that not all of these values may be allowed by the device.",
                    "type": "number",
                    "format": "float",
                    "maximum": 1,
                    "minimum": 0,
