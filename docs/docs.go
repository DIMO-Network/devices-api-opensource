...
// 2022-08-15 12:53:59.062963 -0400 EDT m=+1.398193584
package docs
...
const docTemplate = `{
    ...
    "definitions": {
        ...
        "github.com_DIMO-Network_devices-api_internal_controllers.DeviceCommandRequest": {
            "type": "object",
            "properties": {
                "command": {
                    "type": "string",
                ...
                "integrationId": {
                    "type": "string",
                    "example": "2D8LqXhGRUG8dUUBnk4Z7NRsI54"
                },
                "status": {
                    "type": "string",
                    "enum": [
        ...
        "github.com_DIMO-Network_devices-api_internal_controllers.UserDeviceFull": {
            ...
            "properties": {
                ...
                "recentCommands": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/github.com_DIMO-Network_devices-api_internal_controllers.DeviceCommandRequest"
                    }
                },
                "vin": {
                    "type": "string"
        ...
        "internal_controllers.DeviceCommandRequest": {
            "type": "object",
            "properties": {
                "command": {
                    "type": "string",
        ...
        "internal_controllers.UserDeviceFull": {
            ...
            "properties": {
                ...
                "recentCommands": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/internal_controllers.DeviceCommandRequest"
                    }
                },
                "vin": {
                    "type": "string"
