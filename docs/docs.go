...
// 2023-01-24 16:56:42.459475 -0500 EST m=+1.608956251
package docs
...
const docTemplate = `{
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/github_com_DIMO-Network_devices-api_internal_controllers.PrivilegedDevices"
                        }
                    }
                }
            }
    ...
    "definitions": {
        ...
        "github_com_DIMO-Network_devices-api_internal_controllers.Device": {
            "type": "object",
            "properties": {
                "make": {
                    "type": "string"
        ...
        "github_com_DIMO-Network_devices-api_internal_controllers.PrivilegedAccessDevice": {
            "type": "object",
            "properties": {
                "ownerAddress": {
                    "type": "array",
                ...
                "type": {
                    "$ref": "#/definitions/github_com_DIMO-Network_devices-api_internal_controllers.Device"
                }
            }
        },
        "github_com_DIMO-Network_devices-api_internal_controllers.PrivilegedDevices": {
            "type": "object",
            "properties": {
                "devices": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/github_com_DIMO-Network_devices-api_internal_controllers.PrivilegedAccessDevice"
                    }
                }
            }
        },
        ...
        "internal_controllers.PrivilegedAccessDevice": {
            "type": "object",
            "properties": {
                "ownerAddress": {
                    "type": "array",
                ...
                "type": {
                    "$ref": "#/definitions/internal_controllers.Device"
                }
            }
        },
        "internal_controllers.PrivilegedDevices": {
            "type": "object",
            "properties": {
                "devices": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/internal_controllers.PrivilegedAccessDevice"
                    }
                }
            }
        },
