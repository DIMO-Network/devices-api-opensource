...
// 2022-04-20 15:47:50.768828 -0400 EDT m=+79.711597001
package docs
...
const docTemplate = `{
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/services.UserDeviceAPIIntegrationJob"
                        }
                    }
                }
            }
    ...
    "definitions": {
        ...
        "services.UserDeviceAPIIntegrationJob": {
            "type": "object",
            "properties": {
                "command_job_id": {
                    "type": "string"
