...
// 2023-01-04 16:41:24.983901 -0500 EST m=+1.662690876
package docs
...
const docTemplate = `{
            ...
            "post": {
                ...
                "responses": {
                    "201": {
                        "description": "Created",
                        "schema": {
                            "$ref": "#/definitions/github_com_DIMO-Network_devices-api_internal_api.CreateResponse"
                        }
                    }
                }
            }
    ...
    "definitions": {
        ...
        "github_com_DIMO-Network_devices-api_internal_api.CreateResponse": {
            "type": "object",
            "properties": {
                "id": {
                    "type": "string"
