...
var DeviceDefinitionWhere = struct {
	...
	DeviceMakeID: whereHelperstring{field: "\"devices_api\".\"device_definitions\".\"device_make_id\""},
}
...
func (r *deviceDefinitionR) GetExternalVinData() ExternalVinDatumSlice {
	if r == nil {
		return nil
	}
...
func (r *deviceDefinitionR) GetUserDevices() UserDeviceSlice {
	if r == nil {
		return nil
	}
...
func (o *DeviceDefinition) ExternalVinData(mods ...qm.QueryMod) externalVinDatumQuery {
	var queryMods []qm.QueryMod
	if len(mods) != 0 {
		queryMods = append(queryMods, mods...)
	}
	...
	queryMods = append(queryMods,
		qm.Where("\"devices_api\".\"external_vin_data\".\"device_definition_id\"=?", o.ID),
	)
...
func (o *DeviceDefinition) UserDevices(mods ...qm.QueryMod) userDeviceQuery {
	...
	queryMods = append(queryMods,
		qm.Where("\"devices_api\".\"user_devices\".\"device_definition_id\"=?", o.ID),
	)
...
func (deviceDefinitionL) LoadDeviceMake(ctx context.Context, e boil.ContextExecutor, singular bool, maybeDeviceDefinition interface{}, mods queries.Applicator) error {
	...
	query := NewQuery(
		qm.From(`devices_api.device_makes`),
		qm.WhereIn(`devices_api.device_makes.id in ?`, args...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
// loaded structs of the objects. This is for a 1-M or N-M relationship.
func (deviceDefinitionL) LoadExternalVinData(ctx context.Context, e boil.ContextExecutor, singular bool, maybeDeviceDefinition interface{}, mods queries.Applicator) error {
	var slice []*DeviceDefinition
	var object *DeviceDefinition
	...
	query := NewQuery(
		...
		qm.WhereIn(`devices_api.external_vin_data.device_definition_id in ?`, args...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
// loaded structs of the objects. This is for a 1-M or N-M relationship.
func (deviceDefinitionL) LoadUserDevices(ctx context.Context, e boil.ContextExecutor, singular bool, maybeDeviceDefinition interface{}, mods queries.Applicator) error {
	var slice []*DeviceDefinition
	var object *DeviceDefinition
	...
	query := NewQuery(
		...
		qm.WhereIn(`devices_api.user_devices.device_definition_id in ?`, args...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
func (o *DeviceDefinition) SetDeviceMake(ctx context.Context, exec boil.ContextExecutor, insert bool, related *DeviceMake) error {
	...
	updateQuery := fmt.Sprintf(
		"UPDATE \"devices_api\".\"device_definitions\" SET %s WHERE %s",
...
// Sets related.R.DeviceDefinition appropriately.
func (o *DeviceDefinition) AddExternalVinData(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*ExternalVinDatum) error {
	var err error
	for _, rel := range related {
		if insert {
...
// Sets o.R.DeviceDefinition's ExternalVinData accordingly.
// Replaces o.R.ExternalVinData with related.
// Sets related.R.DeviceDefinition's ExternalVinData accordingly.
func (o *DeviceDefinition) SetExternalVinData(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*ExternalVinDatum) error {
	query := "update \"devices_api\".\"external_vin_data\" set \"device_definition_id\" = null where \"device_definition_id\" = $1"
...
func (o *DeviceDefinition) RemoveExternalVinData(ctx context.Context, exec boil.ContextExecutor, related ...*ExternalVinDatum) error {
	if len(related) == 0 {
		return nil
	}
...
// Sets related.R.DeviceDefinition appropriately.
func (o *DeviceDefinition) AddUserDevices(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*UserDevice) error {
	var err error
	for _, rel := range related {
		if insert {
			rel.DeviceDefinitionID = o.ID
