...
var DeviceStyleWhere = struct {
	...
	Name:               whereHelperstring{field: "\"devices_api\".\"device_styles\".\"name\""},
	ExternalStyleID:    whereHelperstring{field: "\"devices_api\".\"device_styles\".\"external_style_id\""},
...
func (r *deviceStyleR) GetUserDevices() UserDeviceSlice {
	if r == nil {
		return nil
	}
...
func DeviceStyles(mods ...qm.QueryMod) deviceStyleQuery {
	mods = append(mods, qm.From("\"devices_api\".\"device_styles\""))
	q := NewQuery(mods...)
	if len(queries.GetSelect(q)) == 0 {
		queries.SetSelect(q, []string{"\"devices_api\".\"device_styles\".*"})
	}
...
func FindDeviceStyle(ctx context.Context, exec boil.ContextExecutor, iD string, selectCols ...string) (*DeviceStyle, error) {
	...
	query := fmt.Sprintf(
		"select %s from \"devices_api\".\"device_styles\" where \"id\"=$1", sel,
	)
...
func (o *DeviceStyle) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	...
	if !cached {
		...
		if len(wl) != 0 {
			cache.query = fmt.Sprintf("INSERT INTO \"devices_api\".\"device_styles\" (\"%s\") %%sVALUES (%s)%%s", strings.Join(wl, "\",\""), strmangle.Placeholders(dialect.UseIndexPlaceholders, len(wl), 1, 1))
		} else {
			cache.query = "INSERT INTO \"devices_api\".\"device_styles\" %sDEFAULT VALUES%s"
		}
...
func (o *DeviceStyle) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		cache.query = fmt.Sprintf("UPDATE \"devices_api\".\"device_styles\" SET %s WHERE %s",
...
func (o DeviceStyleSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	sql := fmt.Sprintf("UPDATE \"devices_api\".\"device_styles\" SET %s WHERE %s",
...
func (o *DeviceStyle) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
	...
	if !cached {
		...
		cache.query = buildUpsertQueryPostgres(dialect, "\"devices_api\".\"device_styles\"", updateOnConflict, ret, update, conflict, insert)
...
func (o *DeviceStyle) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	sql := "DELETE FROM \"devices_api\".\"device_styles\" WHERE \"id\"=$1"
...
func (o DeviceStyleSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	sql := "DELETE FROM \"devices_api\".\"device_styles\" WHERE " +
...
func (o *DeviceStyleSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	sql := "SELECT \"devices_api\".\"device_styles\".* FROM \"devices_api\".\"device_styles\" WHERE " +
		strmangle.WhereClauseRepeated(string(dialect.LQ), string(dialect.RQ), 1, deviceStylePrimaryKeyColumns, len(*o))
...
func DeviceStyleExists(ctx context.Context, exec boil.ContextExecutor, iD string) (bool, error) {
	var exists bool
	sql := "select exists(select 1 from \"devices_api\".\"device_styles\" where \"id\"=$1 limit 1)"
