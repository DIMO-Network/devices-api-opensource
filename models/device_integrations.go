...
var (
	deviceIntegrationAllColumns            = []string{"device_definition_id", "integration_id", "capabilities", "created_at", "updated_at", "region"}
...
func DeviceIntegrations(mods ...qm.QueryMod) deviceIntegrationQuery {
	...
	if len(queries.GetSelect(q)) == 0 {
		queries.SetSelect(q, []string{"\"devices_api\".\"device_integrations\".*"})
	}
