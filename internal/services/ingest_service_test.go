...
func TestIngestDeviceStatus(t *testing.T) {
	...
	scIntegration := models.Integration{
		ID:     ksuid.New().String(),
	...
	_ = scIntegration.Insert(ctx, pdb.DBS().Writer, boil.Infer())

	dd := models.DeviceDefinition{
		ID: ksuid.New().String(),
	}

	_ = dd.Insert(ctx, pdb.DBS().Writer, boil.Infer())
	...
	_ = udai.Insert(ctx, pdb.DBS().Writer, boil.Infer())
